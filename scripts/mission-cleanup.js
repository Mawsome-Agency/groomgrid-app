 ...
 * 
 * Required env: CORTEX_TOKEN (for API access)
 */
...
const COMPANY_ID = 'cmm79fsxz00ephmk3xjtx9scd';
...
async function fetchMissions() {
  return new Promise((resolve, reject) => {
    const url = `${API_BASE}/missions?companyId=${COMPANY_ID}&department=${DEPARTMENT}`;
...
async function main() {
  ...
  // Implementation would go here - requires DELETE endpoint
  console.log('\n⚠️  Execute mode requires DELETE API implementation');
  console.log('   This script identifies missions to clean up;');
  console.log('   Manual API calls or admin UI actions required to complete.');
}
