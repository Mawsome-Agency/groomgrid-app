  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        {/* ── Related Links ── */}
        <RelatedLinks
          heading="Run your mobile grooming business from one app"
          links={[
          { href: '/signup', category: 'Getting Started', title: 'How to Start a Mobile Dog Grooming Business: Step-by-Step Guide' },
        ...
        {/* ── Footer ── */}
        <SiteFooter links={[{ href: '/mobile-grooming-business/', label: 'Mobile Grooming' }, { href: '/grooming-business-operations/', label: 'Operations Hub' }, { href: '/plans', label: 'Pricing' }, { href: '/signup', label: 'Sign Up' }]} />
      </div>
    </>
  );
}
