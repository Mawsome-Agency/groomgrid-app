    ...
    <>      <Script
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        <div className="px-6 py-3 max-w-5xl mx-auto">
          <PageBreadcrumbs slug="blog/groomgrid-vs-daysmart" />
        </div>
        ...
        {/* ── Related Links ── */}
        <PageRelatedLinks slug="blog/groomgrid-vs-daysmart" variant="blog" heading="Try GroomGrid free — 50% off your first month" />

        {/* ── Footer ── */}
        <SiteFooter slug="blog/groomgrid-vs-daysmart" />
      </div>
    </>
  );
}
