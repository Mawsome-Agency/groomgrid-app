    ...
    <>      <Script
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        <div className="px-6 py-3 max-w-5xl mx-auto">
          <PageBreadcrumbs slug="blog/pet-grooming-software" />
        </div>
        ...
        {/* ── Related Links ── */}
        <PageRelatedLinks slug="blog/pet-grooming-software" variant="blog" heading="Ready to run your grooming business smarter?" />

        {/* ── Footer ── */}
        <SiteFooter slug="blog/pet-grooming-software" />
      </div>
    </>
  );
}
