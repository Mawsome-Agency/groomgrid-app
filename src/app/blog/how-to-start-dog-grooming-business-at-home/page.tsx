    ...
    <>      <Script
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        <div className="px-6 py-3 max-w-5xl mx-auto">
          <PageBreadcrumbs slug="blog/how-to-start-dog-grooming-business-at-home" />
        </div>
        ...
        {/* ── Related Links ── */}
        <PageRelatedLinks slug="blog/how-to-start-dog-grooming-business-at-home" variant="blog" heading="Run your home grooming business like a pro" />

        {/* ── Footer ── */}
        <SiteFooter slug="blog/how-to-start-dog-grooming-business-at-home" />
      </div>
    </>
  );
}
