    ...
    <>      <Script
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        <div className="px-6 py-3 max-w-5xl mx-auto">
          <PageBreadcrumbs slug="blog/mobile-dog-grooming-business-tips" />
        </div>
        ...
        {/* ── Related Links ── */}
        <PageRelatedLinks slug="blog/mobile-dog-grooming-business-tips" variant="blog" heading="Software built for mobile groomers" />

        {/* ── Footer ── */}
        <SiteFooter slug="blog/mobile-dog-grooming-business-tips" />
      </div>
    </>
  );
}
