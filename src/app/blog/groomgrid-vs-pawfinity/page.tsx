  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        {/* ── Related Links ── */}
        <RelatedLinks
          heading="Ready to upgrade? Try GroomGrid — 50% off your first month"
          links={[
          { href: '/signup?coupon=BETA50', category: 'Comparison', title: 'GroomGrid vs MoeGo: Which is Right for You?' },
          { href: '/blog/reduce-no-shows-dog-grooming', category: 'Operations', title: 'How to Reduce No-Shows in Your Grooming Business' }
          ]}
          columns={3}
        />
