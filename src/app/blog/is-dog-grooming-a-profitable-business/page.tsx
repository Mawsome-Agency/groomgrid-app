    ...
    <>
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        <RelatedLinks
          ...
          links={[
          { href: '/signup', category: 'Business Management', title: 'Dog Grooming Business Management: The Complete Guide' },
          { href: '/blog/dog-grooming-contract-template', category: 'Templates', title: 'Dog Grooming Contract Template: What to Include and Why' }
          ]}
          columns={3}
        />
