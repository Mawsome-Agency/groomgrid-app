    ...
    <>      <Script
      ...
      <div className="min-h-screen bg-white text-stone-900">
        ...
        <div className="px-6 py-3 max-w-5xl mx-auto">
          <PageBreadcrumbs slug="blog/is-dog-grooming-a-profitable-business" />
        </div>
        ...
        {/* ── Related Links ── */}
        <PageRelatedLinks slug="blog/is-dog-grooming-a-profitable-business" variant="blog" heading="Ready to streamline your grooming business?" />

        {/* ── Footer ── */}
        <SiteFooter slug="blog/is-dog-grooming-a-profitable-business" />
      </div>
    </>
  );
}
